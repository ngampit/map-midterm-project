...
INSERT INTO markers (user_id, map_id, title, lat, long, created_at, description, icon_id) VALUES (1, 1, 'Cafe Vancouver', 49.2814100447562, -123.08536284114001, NOW(), 'A lovely cafe in Vancouver', 4);

INSERT INTO markers (user_id, map_id, title, lat, long, created_at, description, icon_id) VALUES (2, 2, 'Hotel in Tehran', 35.79313274353771, 51.356337069352, NOW(), 'A great hotel in Tehran', 1);

INSERT INTO markers (user_id, map_id, title, lat, long, created_at, description, icon_id) VALUES (3, 3, 'Tourist attraction in Bangkok', 13.743939688183945, 100.48894795560622, NOW(), 'A great place in Bangkok', 5);

INSERT INTO markers (user_id, map_id, title, lat, long, created_at, description, icon_id) VALUES (4, 4, 'Bar at Rio de Janeiro', -22.919211866381897, -43.23496761717818, NOW(), 'Fun bar at Rio de Janeiro', 3);
